...
<head>
    ...
    <link rel="stylesheet" href="../../../css/dashAdmStyle.css">
                    ...
                    <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="card-text">Chamados Criados</p>
                                        </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="card" >
                                        <div class="card-body" >
                                            <p class="card-text">Chamados p/Unidades</p>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="card-text">Candidatos p/Unidades</p>
                        ...
                        <div class="col-md-4">
                            <div class="card-grande ">
                                <div class="card-body">
                                    <p class="card-text">Histórico de Chamados</p>
                                </div>
                                <?php
                                // Conectar ao banco de dados
                                $servername = "50.116.86.120";
            ...
            const lineData = {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        borderColor: 'rgb(120, 154, 76)',
                        borderWidth: 1,
                        backgroundColor: 'rgb(120, 154, 76)',
                    }
                ]
            };
