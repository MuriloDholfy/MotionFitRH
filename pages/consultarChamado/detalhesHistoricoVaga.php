            ...
            <div class="col-md-11">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<h1 class="card-text mb-5" style="color:#fff">Detalhe Vaga</h1>';
                        ...
                        echo '    <div class="row">';
                        echo '      <div class="col-md-6">';
                        echo '        <p class="card-text"><strong>Horário Inicial:</strong> ' . htmlspecialchars($row['horarioInicioVaga']) . '</p>';
                        echo '        <p class="card-text"><strong>Horário Final:</strong> ' . htmlspecialchars($row['horarioFinalVaga']) . '</p>';
                        ...
                        echo '    <a href="process.php?id=' . htmlspecialchars($row['idVaga']) . '&acao=aprovar" class="btn btn-success">Aprovar</a>';
                        echo '    <a href="process.php?id=' . htmlspecialchars($row['idVaga']) . '&acao=rejeitar" class="btn btn-danger">Rejeitar</a>';
                        echo '    <a href="process.php?id=' . htmlspecialchars($row['idVaga']) . '&acao=cancelar" class="btn btn-danger">Cancelar</a>';
                        echo '  </div>';
                        echo '</div>';
                    }
                } else {
